...
(function (SevenThree) {
    ...
    (function (Model) {
        ...
        var Field = (function () {
            ...
            Field.prototype.setPhase = function (phase) {
                this.phase = phase;
            };
            Field.prototype.setBPoint = function (bp) {
                this.B_point = bp;
...
(function (SevenThree) {
    ...
    var Phase = SevenThree.Model.Phase;
    (function (Mode) {
    ...
    var Controller = (function () {
        function Controller() {
            ...
            console.log(this.field.B_point);
        ...
        Controller.prototype.changePhase = function () {
            if (this.field.phase == Phase.A) {
                this.field.phase = Phase.B;
                this.phaseText = "B";
            }
            else {
                this.field.phase = Phase.A;
                this.phaseText = "A";
            }
        };
        Controller.prototype.setBPoint = function () {
            console.log(this.bpText);
            this.field.setBPoint(parseInt(this.bpText));
        };
